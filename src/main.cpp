...
uint256 hashGenesisBlock("0x234b1401161c0823fb86d60feefe74bca20c3ec40aaa7124f9fceed30bf9fced");
...
const string strMessageMagic = "GrifCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 2 * 24 * 60 * 60; // GrifCoin: 2 days
static const int64 nTargetSpacing = 120; // GrifCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal grifcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "GrifCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x4d1ea68ba7a423e8a5f6eedd1c1b9b9c495f28f9015ac10eb3affe4708e843b9");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1401408921; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2662926;

        if (fTestNet)
        {
            block.nTime    = 1401089786;
            block.nNonce   = 1987171;
        }
